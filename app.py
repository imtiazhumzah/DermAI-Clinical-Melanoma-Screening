...
# --- 2. Step 1 & 2 Logic: Validation & ABCDE Analysis ---
...
def generate_report(diagnosis, confidence, age, sex, site, status, abcde):
    ...
    pdf.multi_cell(0, 8, text=f"Actionable Guidance: {clean_status}")
...
with gr.Blocks(theme=gr.themes.Soft()) as demo:
    gr.Markdown("# 🩺 DermAI: Decision Support System")
    ...
    with gr.Row():
        ...
        with gr.Column(scale=3):
            ...
            output_status = gr.Textbox(label="Clinical Indicators & Triage", lines=8)
